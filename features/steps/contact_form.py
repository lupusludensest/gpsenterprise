...
def inpt_frst_nm(context, frst_nm):
    context.app.cntct_frm_page.inpt_frst_nm(frst_nm)
...
def inpt_phn_nmbr(context, phn_nmbr):
    context.app.cntct_frm_page.inpt_phn_nmbr(phn_nmbr)
...
def txt_hr(context, txt_cnfrmtn):
    context.app.cntct_frm_page.main_page.txt_hr(txt_cnfrmtn)